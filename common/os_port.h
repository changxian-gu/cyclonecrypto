...
#define osMemset(p, value, length) (void) myosMemset(p, value, length)
#ifndef osMemset
   #include <string.h>
...
#define osMemcpy(dest, src, length) (void) myosMemcpy(dest, src, length)
#ifndef osMemcpy
   #include <string.h>
...
#define osMemmove(dest, src, length) (void) myosMemmove(dest, src, length)
#ifndef osMemmove
   #include <string.h>
...
#define osMemcmp(p1, p2, length) myosMemcmp(p1, p2, length)
#ifndef osMemcmp
   #include <string.h>
...
#define osMemchr(p, c, length) myosMemchr(p, c, length)
#ifndef osMemchr
   #include <string.h>
...
//Get string length
#define osStrlen(s) myosStrlen(s)
#ifndef osStrlen
   #include <string.h>
...
//Compare strings
#define osStrcmp(s1, s2) myosStrcmp(s1, s2)
#ifndef osStrcmp
   #include <string.h>
...
//Compare substrings
#define osStrncmp(s1, s2, length) myosStrncmp(s1, s2, length)
#ifndef osStrncmp
   #include <string.h>
...
#define osStrcasecmp(s1, s2) myosStrcasecmp(s1, s2)
#ifndef osStrcasecmp
   #include <string.h>
...
#define osStrncasecmp(s1, s2, length) myosStrncasecmp(s1, s2, length)
...
//Search for the first occurrence of a given character
#define osStrchr(s, c) myosStrchr(s, c)
#ifndef osStrchr
   #include <string.h>
...
#define osStrstr(s1, s2) myosStrstr(s1, s2)
#ifndef osStrstr
   #include <string.h>
...
//Copy string
#define osStrcpy(s1, s2) (void) myosStrcpy(s1, s2)
#ifndef osStrcpy
   #include <string.h>
...
#define osStrncpy(s1, s2, length) (void) myosStrncpy(s1, s2, length)
#ifndef osStrncpy
   #include <string.h>
...
//Concatenate strings
   #define osStrcat(s1, s2) (void) myosStrcat(s1, s2)
#ifndef osStrcat
   #include <string.h>
